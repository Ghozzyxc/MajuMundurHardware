...
<html>
<head>
<title>MAJU MUNDUR HARDWERE</title>
<!-- for-mobile-apps -->
	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
			...
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php">MAJU MUNDUR HARDWERE</a></h1>
			</div>
...
<!-- //navigation -->
	<!-- main-slider -->
		<ul id="demo1">
			<li>
				<img src="images/slide1.jpg" alt="" width="500" height="700"/>
			</li>
			<li>
				<img src="images/slide2.jpg" alt="" width="500" height="800"/>
			</li>
			
			<li>
				<img src="images/slide3.png" alt="" width="500" height="800"/>
			</li>
		</ul>
	<!-- //main-slider -->
...
<div class="footer">
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>NanaShi Lab, Magetan.</li>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2022 NanaShi Lab. All rights reserved</p>
			</div>
		</div>
